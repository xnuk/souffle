...
const Checkbox: FC<{
	...
	return <label class={styles.checkboxItem}>
...
const SettingMenu: FC = ({ children }) => {
	return <details class={styles.setting}>
		<summary class={styles.toggleBtn} onClick={event => event.currentTarget.blur()}>
...
export const Setting = () => <SettingMenu>
	<Preferences />
</SettingMenu>
